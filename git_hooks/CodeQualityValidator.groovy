...
class CodeQualityValidator {
    ...
    public CodeQualityValidator(fileContentProvider) {
        ...
        def serviceGroups = ["OSB.Common", "OSB.CommonServices", "OSB.CoreServices", "OSB.EventServices", "OSB.QueryServices", "OSB.ReferenceDataServices", "OSB.ScanServices"]
    ...
    public void performValidation() {
        ...
        while (currentFile != null) {
            println "Processing file ${currentFile.path}/${currentFile.name}"
            def fileTypeName = deriveFileType(currentFile)
//            println fileTypeName
