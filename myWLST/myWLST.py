...
def connectToNM(encryption='SSL'):
    '''Connect to Node Manager'''
    msg("Connecting to NM with details {" + nmUsername + " | " + host + " | " + nmPort + " | " + domainName + " | " + domainHome + "}", _LOG_LEVEL.DEBUG)
    nmConnect(nmUsername, nmPassword, host, nmPort, domainName, domainHome, encryption)
